...
module.exports = function(arguments){
	return new Promise((resolve, reject) => {
		...
		snippet += arguments[3]
		snippet += '" class="iconForward iconForwardWhite" style="font-family: sans-serif; font-size: 20px; font-weight:bold;text-align: center;line-height: 24px; display: inline-block; vertical-align: middle; position: relative; padding-right: 2.6em; color:'
		snippet += arguments[1]
		snippet += '; background: ' 
		snippet += arguments[0]
